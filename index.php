        ...
        <div class="row">
            <div class="col-md-6 portfolio-item">
                <a href="https://unsplash.com/photos/SYx3UCHZJlo">
                    <img class="img-responsive" src="assets/images/1.jpeg" alt="" width="555" height="370">
                </a>
                <h3>
            ...
            <div class="col-md-6 portfolio-item">
                <a href="https://unsplash.com/photos/o_rKNRoNz8s">
                    <img class="img-responsive" src="assets/images/2.jpeg" alt="" width="555" height="370">
                </a>
                <h3>
        ...
        <div class="row">
            <div class="col-md-6 portfolio-item">
                <a href="https://unsplash.com/photos/MS7KD9Ti7FQ">
                    <img class="img-responsive" src="assets/images/3.jpeg" alt="" width="555" height="370">
                </a>
                <h3>
            ...
            <div class="col-md-6 portfolio-item">
                <a href="https://unsplash.com/photos/1VYdx37vOGQ">
                    <img class="img-responsive" src="assets/images/4.jpeg" alt="" width="555" height="370">
                </a>
                <h3>
        ...
        <div class="row">
            <div class="col-md-6 portfolio-item">
                <a href="https://unsplash.com/photos/7yqyQQXgOT8">
                    <img class="img-responsive" loading="lazy" src="assets/images/5.jpeg" alt="" width="555" height="370">
                </a>
                <h3>
            ...
            <div class="col-md-6 portfolio-item">
                <a href="https://unsplash.com/photos/PfK35Iw1JAo">
                    <img class="img-responsive" loading="lazy" src="assets/images/6.jpeg" alt="" width="555" height="370">
                </a>
                <h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 footer-blurb-item">
                        <img class="img-circle" loading="lazy" src="assets/images/7.jpeg" alt="" width="100" height="100">
                        <h3>My Stuff</h3>
                    ...
                    <div class="col-sm-4 footer-blurb-item">
                        <img class="img-circle" loading="lazy" src="assets/images/8.jpeg" alt="" width="100" height="100">
                        <h3>Your Stuff</h3>
                        <p>Upon yielding, kind sea subdue very seed sixth them lesser one lesser there earth days were
                            multiply so sixth gathering fifth that man fowl made.</p>
                    ...
                    <div class="col-sm-4 footer-blurb-item">
                        <img class="img-circle" loading="lazy" src="assets/images/9.jpeg" alt="" width="100" height="100">
                        <h3>Our Stuff</h3>
                        <p>Upon yielding, kind sea subdue very seed sixth them lesser one lesser there earth days were
                            multiply so sixth gathering fifth that man fowl made.</p>
